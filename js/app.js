...
function toggleDashboardPlus(){let m=document.getElementById('dashboardPlusMenu');if(m)m.classList.toggle('show');}

function toggleHeaderDropdown(){let d=document.getElementById('plusDropdown');if(d)d.classList.toggle('show');}
